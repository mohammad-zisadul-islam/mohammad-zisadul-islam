  ...
  <section class="section">
    ...
    <div class="terminal">
      ...
      <div class="terminal-body">
        ...
        <div><span style="padding-left:20px" class="t-key">"education"</span><span class="t-out">: </span><span class="t-val">"BSc CSE @ AIUB | Major: Network Security | CGPA 3.54"</span></div>
        <div class="t-out">}</div>
        <br/>
